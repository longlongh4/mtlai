...
#ifndef TWITTERONGOOGLEMAP_H
#define TWITTERONGOOGLEMAP_H

#include <QtWebKit/QWebView>

class TwitterOnGoogleMap : public QWebView
{
    Q_OBJECT
public:
    explicit TwitterOnGoogleMap(QWidget *parent = 0);
