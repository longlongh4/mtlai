...
#ifndef MTMULTIMEDIAWIDGET_H
#define MTMULTIMEDIAWIDGET_H

#include <QWidget>

class MtMultimediaWidget : public QWidget
{
    Q_OBJECT
public:
    explicit MtMultimediaWidget(QWidget *parent = 0);
